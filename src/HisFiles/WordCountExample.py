...
def main():
	...
	if len(sys.argv) != 3:
		print("Usage: python WordCountExample.py <K> <file_name>")
		return
	...
	print("Number of distinct words in the documents =", word_count_2(docs, L).count())

	# 2-ROUND WORD COUNT - RANDOM KEYS ASSIGNED ON THE FLY
	print("Number of distinct words in the documents =", word_count_3(docs, L).count())
